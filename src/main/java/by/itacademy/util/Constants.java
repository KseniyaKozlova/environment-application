...
public class Constants {
    ...
    public static final String UPDATE_COMPANY_URL = "/company/update/{id}";
    public static final String DELETE_COMPANY_URL = "/company/delete/{id}";
    ...
    public static final String UPDATE_COUPON_URL = "/coupon/update/{id}";
    public static final String DELETE_COUPON_URL = "/coupon/delete/{id}";
    ...
    public static final String UPDATE_TARE_URL = "/tare/update/{id}";
    public static final String DELETE_TARE_URL = "/tare/delete/{id}";
    ...
    public static final String UPDATE_USER_URL = "/user/update/{id}";
    public static final String DELETE_USER_URL = "/user/delete/{id}";
    public static final String DEPOSIT_TARE_BY_USER_URL = "/user/{userId}/deposit_tare/{tareId}";
    public static final String BUY_COUPON_BY_USER_URL = "/user/{userId}/buy_coupon/{couponId}";
    public static final String USE_COUPON_BY_USER_URL = "/user/{userId}/use_coupon/{couponId}";
    public static final String RETURN_COUPON_BY_USER_URL = "/user/{userId}/return_coupon/{couponId}";
