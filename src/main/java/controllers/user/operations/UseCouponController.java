...
@WebServlet(urlPatterns = USERS_USE_COUPON_URL)
public class UseCouponController extends HttpServlet {
    ...
    protected void doPost(final HttpServletRequest req, final HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            final UUID couponId = fromString(req.getParameter(ID));
            userService.useCoupon(userId, couponId);
            req.getRequestDispatcher(USER_USE_COUPON_PAGE).forward(req, resp);
